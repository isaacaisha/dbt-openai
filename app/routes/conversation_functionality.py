...
functionality_conversation_bp = Blueprint('conversation_function', __name__)


@functionality_conversation_bp.route('/select-conversation-id', methods=['GET', 'POST'])
...
@functionality_conversation_bp.route('/conversation/<int:conversation_id>')
...
@functionality_conversation_bp.route('/delete-conversation', methods=['GET', 'POST'])
